...
public class SAMFileInfo {
	...
	public SAMFileInfo(SamReader reader) {
	...
	public static void writeBAMMetrics(SamReader reader, ArrayList<String> libraries, String outputFile, int sampleSize) {
	...
	private static HashMap<String, Point2D.Float> getInsertSizeMeanStdDev(SamReader reader, ArrayList<String> libraries, int sampleSize) {
	...
	private static HashMap<String, Integer> getLibraryReadLengths(SamReader reader, ArrayList<String> libraries) {
		HashMap<String, Integer> readLengths = new HashMap<String, Integer>();
